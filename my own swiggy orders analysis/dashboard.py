...
df=pd.read_json("swiggy_order_summary.txt")
...
app.layout = html.Div(children=[
    ...
    html.H6(children='Visualizing Swiggy Order History - Naveen Saharan', style={'textAlign': 'center'}),
    ...
    ], target='_blank', href='https://www.linkedin.com/in/saharannaveen/', style={
                    'height' : '36px',
                    'width' : '36px',
                    'float' : 'right',
